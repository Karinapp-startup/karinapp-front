...
interface DetailModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onEdit: (complaint: ComplaintType) => void;
  isLoading: boolean;
}

const SECTION_STEPS = {
  employer: "1",        // EmployerForm
  victim: "2",         // VictimForm
  accused: "3",        // AccusedForm
  relationship: "4",   // RelationshipForm
  situations: "5",     // SituationsForm
  witness: "6",        // WitnessForm
  reportedFacts: "7",  // ReportedFactsForm
  reportedSituations: "8", // ReportedSituationsForm
  safeguardMeasures: "9", // SafeguardMeasuresForm
  summary: "10"        // SummaryForm
} as const;

export function DetailModal({ complaint, isOpen, onClose, onEdit, isLoading }: DetailModalProps) {
  const router = useRouter();
  const currentStep = complaint.step.split('/')[0];

  // Componente EditButton que se muestra si no es etapa 9
  const EditButton = ({ stepNumber }: { stepNumber: string }) => {
    ...
    return (
      <Button
        ...
        onClick={() => onEdit({ ...complaint, step: `${stepNumber}/9` })}
        disabled={isLoading}
      >
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <EditButton stepNumber={SECTION_STEPS.employer} />
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <EditButton stepNumber={SECTION_STEPS.victim} />
                </div>
                <div className="grid grid-cols-2 gap-4 bg-white p-2">
                  <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <EditButton stepNumber={SECTION_STEPS.accused} />
                </div>
                <div className="grid grid-cols-2 gap-4 bg-white p-2">
                  <div>
                    <label className="text-sm text-gray-500">Nombres</label>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <EditButton stepNumber={SECTION_STEPS.relationship} />
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <EditButton stepNumber={SECTION_STEPS.witness} />
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <EditButton stepNumber={SECTION_STEPS.reportedFacts} />
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <EditButton stepNumber={SECTION_STEPS.reportedSituations} />
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <EditButton stepNumber={SECTION_STEPS.safeguardMeasures} />
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <EditButton stepNumber={SECTION_STEPS.summary} />
                </div>
                <div className="bg-white p-4 border rounded-lg">
                  <p className="text-sm text-gray-600 whitespace-pre-line">
                    Acá van todos los acontecimientos que denuncia ala víctima en un párrafo muy detallado y extenso.
